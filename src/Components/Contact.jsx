...
const Contact = () => {
    return (
        <div className='shadow-[0px_4px_12px_rgba(0,0,0,0.4)] rounded-xl px-12 py-8 mb-24'>
            <div className='text-center' data-aos="fade-down" data-aos-duration="2000">
                <h2 className="text-3xl md:text-4xl lg:text-4xl font-bold text-[#0F4EFC] inline-block">Contact Me</h2>
