    ...
    return (
        <div className='mb-16'>
            <div className='text-center' data-aos="fade-up"
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-[#0F4EFC] darkDamtext-[#0BBFFF] inline-block mb-1">My Projects</h2>
                <div className="h-1 w-28 bg-[#0F4EFC] darkDambg-[#0BBFFF] mx-auto mt-1 mb-6"></div>
            </div>

            <div>
                {/* Project 1 */}
                <div className='lg:flex items-center shadow-[4px_4px_10px_rgba(0,0,0,0.35)] darkDamshadow-[1px_1px_8px_#0BBFFF] rounded-xl mb-12'>

                    <div className='w-full lg:w-1/2 p-6' data-aos="fade-right"
                        data-aos-duration="2000">
                        <img src={project1Image} className='w-full h-full p-10 border rounded-xl' alt="" />
                    </div>

                    <div className='w-full lg:w-1/2 p-10' data-aos="fade-left"
                        data-aos-duration="2000">
                        <h3 className='text-[#0F4EFC] darkDamtext-[#0BBFFF] text-3xl font-bold mb-2'> Web Horizon </h3>
                        ...
                        <h4 className='text-[#0F4EFC] darkDamtext-[#0BBFFF] text-2xl font-bold mb-2'> Technologies Used </h4>
                        ...
                        <div className=''>
                            <div className='flex gap-x-2'>
                                <a href="https://web-horizon-final.netlify.app/" target='_blank'>
                                    <button className='btn bg-[#A6C8FF] text-[#0f4efc] border-2 border-[#0f4efc] darkDamtext-black darkDambg-[#0BBFFF] darkDamborder-none text-2xl px-2 py-1'> Live Site </button>
                                </a>
                                <a href="https://github.com/muhammad-sayem/Web-Horizon-Client" target='_blank'>
                                    <button className='btn bg-[#A6C8FF] text-[#0f4efc] border-2 border-[#0f4efc] darkDamtext-black darkDambg-[#0BBFFF] darkDamborder-none text-2xl px-2 py-1'> Client Side Github </button>
                                </a>
                                <a href="https://github.com/muhammad-sayem/Web-Horizon-Server" target='_blank'>
                                    <button className='btn bg-[#A6C8FF] text-[#0f4efc] border-2 border-[#0f4efc] darkDamtext-black darkDambg-[#0BBFFF] darkDamborder-none text-2xl px-2 py-1'> Server Side Github </button>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                {/* Project 2 */}
                <div className='lg:flex items-center gap-8 shadow-[4px_4px_10px_rgba(0,0,0,0.35)] darkDamshadow-[1px_1px_8px_#0BBFFF] rounded-xl mb-8'>

                    <div className='w-full lg:w-1/2 p-6' data-aos="fade-right"
                        data-aos-duration="2000">
                        <img src={project2Image} className='w-full h-full p-10 border rounded-xl' alt="" />
                    </div>

                    <div className='w-full lg:w-1/2 p-10' data-aos="fade-left"
                        data-aos-duration="2000">
                        <h3 className='text-[#0F4EFC] darkDamtext-[#0BBFFF] text-3xl font-bold mb-2'> Artifacts Atlas </h3>
                ...
                <div className='lg:flex items-center gap-8 shadow-[4px_4px_10px_rgba(0,0,0,0.35)] darkDamshadow-[1px_1px_8px_#0BBFFF] rounded-xl mb-8'>
                    ...
                    <div className='w-full lg:w-1/2 p-6' data-aos="fade-right"
                        data-aos-duration="2000">
                        <img src={project3Image} className='w-full h-full p-10 border rounded-xl' alt="" />
                    </div>

                    <div className='w-full lg:w-1/2 p-10' data-aos="fade-left"
                        data-aos-duration="2000">
                        <h3 className='text-[#0F4EFC] darkDamtext-[#0BBFFF] text-3xl font-bold mb-2'> Visa Navigator Portal </h3>
