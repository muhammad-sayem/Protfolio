...
const ToolsAndLanguages = () => {
    const singleToolsStyle = 'border border-[#8245EC]/60 rounded-lg flex flex-col items-center py-2 transform transition-transform duration-300 hover:scale-90';
    ...
    return (
        <div className='mb-16'>
            <div className='text-center' data-aos="fade-down"
                ...
                <h2 className="text-3xl md:text-4xl lg:text-4xl font-bold text-white inline-block"> Tools & Languages </h2>
