        ...
        <div id="hero" className='mt-24 mb-20 flex flex-col-reverse md:flex md:flex-row md:justify-center py-6'>
            <div className='md:w-7/12 flex flex-col justify-center pl-6 pr-12 py-8' data-aos="fade-right"
                ...
                <div className='my-4 flex gap-x-2'>
                    <a href="https://github.com/muhammad-sayem" target='_blank' className="text-[#8245EC] darkDamtext-[#00BFFF]"> <FaGithubSquare size={50}></FaGithubSquare> </a>

                    <a href="https://www.linkedin.com/in/md-shahrul-islam-sayem/" target='_blank' className="text-[#8245EC] darkDamtext-[#00BFFF]"> <FaLinkedin size={50}></FaLinkedin> </a>

                    <a href="https://www.facebook.com/shahrulislam.sayem/" target='_blank' className="text-[#8245EC] darkDamtext-[#00BFFF]"> <FaFacebookSquare size={50}></FaFacebookSquare> </a>
                </div>
