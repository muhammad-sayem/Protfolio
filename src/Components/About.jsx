...
const About = () => {
    return (
        <div className="shadow-[4px_4px_10px_rgba(0,0,0,0.35)] darkDamshadow-[1px_1px_8px_#00BFFF] rounded-xl px-8 md:px-16 py-6 md:py-8 mb-16">
            <div className='text-center' data-aos="fade-down" data-aos-duration="2000">
                <h2 className="text-3xl md:text-4xl lg:text-4xl font-bold text-[#0F4EFC] darkDamtext-[#00BFFF] inline-block">About Me</h2>
                <div className="h-1 w-28 bg-[#0F4EFC] darkDambg-[#00BFFF] mx-auto mt-1 mb-4"></div>
            </div>

            <div className='' data-aos="fade-up" data-aos-duration="2000">
                <p className='text-left text-xl md:text-lg mb-4'> Hi! 👋 I'm Md Shahrul Islam Sayem, a <span className='font-bold text-[#0F4EFC] darkDamtext-[#00BFFF]'>Junior Web Developer</span>. I'm passionate about becoming a <span className='font-bold text-[#0F4EFC] darkDamtext-[#00BFFF]'>MERN Stack Developer</span> and fully dedicated to putting in the effort to achieve my goal. </p>

                <h3 className='text-left text-xl md:text-2xl font-bold mb-2 darkDamtext-[#00BFFF]'> My Journey to Programming and Web Development </h3>
                ...
                <h3 className='text-left text-xl md:text-2xl font-bold mb-2 darkDamtext-[#00BFFF]'> The type of work I enjoy </h3>
                ...
                <h3 className='text-left text-xl md:text-2xl font-bold mb-2 darkDamtext-[#00BFFF]'> My work approach </h3>
